  ...
  <action>
    ...
    **Functions to implement:**
    ...
    1. `getPlayerStats(playerId: string, teamId?: string): Promise<PlayerStats | null>`
       ...
       - goals_conceded: Only if player.roles[0] = 'goalkeeper' AND played in GK position
    ...
    **Goals conceded calculation:**
    ...
    -- Check if player.roles[0] = 'goalkeeper'
...
- Goals conceded only for goalkeepers (roles[0] = 'goalkeeper') playing in GK position
