...
export const FORMATION_PRESETS_5VS5: FormationPreset[] = [
  {
    ...
    positions: [
      ...
      { x: 5.7, y: 1.8, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '2-1-1',
    ...
    positions: [
      ...
      { x: 4.7, y: 1.5, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '3-1',
    ...
    positions: [
      ...
      { x: 4.7, y: 1.8, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '1-2-1',
...
export const FORMATION_PRESETS_8VS8: FormationPreset[] = [
  {
    ...
    positions: [
      ...
      { x: 4.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 6.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 4.7, y: 2.0, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '3-2-2',
    ...
    positions: [
      ...
      { x: 4.7, y: 4.7, label: 'DIF', role: 'DEF' },
      { x: 6.7, y: 4.7, label: 'DIF', role: 'DEF' },
      { x: 3.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 5.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 3.7, y: 2.0, label: 'ATT', role: 'FWD' },
      { x: 5.7, y: 2.0, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '2-4-1',
    ...
    positions: [
      ...
      { x: 3.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 5.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 7.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 4.7, y: 2.0, label: 'ATT', role: 'FWD' },
    ],
  },
  {
...
export const FORMATION_PRESETS_11VS11: FormationPreset[] = [
  {
    ...
    positions: [
      ...
      { x: 3.7, y: 4.7, label: 'DIF', role: 'DEF' },
      { x: 5.7, y: 4.7, label: 'DIF', role: 'DEF' },
      { x: 7.7, y: 4.7, label: 'DIF', role: 'DEF' },
      // Centrocampo a 3
      { x: 2.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 4.7, y: 3.4, label: 'CEN', role: 'MID' },
      { x: 6.7, y: 3.4, label: 'CEN', role: 'MID' },
      // Attacco a 3
      { x: 2.7, y: 2.0, label: 'ATT', role: 'FWD' },
      { x: 4.7, y: 2.0, label: 'ATT', role: 'FWD' },
      { x: 6.7, y: 2.0, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '4-4-2',
  ...
  },
  {
    ...
    positions: [
      ...
      { x: 5.7, y: 3.4, label: 'CEN', role: 'MID' },
      // Trequartisti a 3
      { x: 2.7, y: 2.2, label: 'ATT', role: 'FWD' },
      { x: 4.7, y: 2.2, label: 'ATT', role: 'FWD' },
      { x: 6.7, y: 2.2, label: 'ATT', role: 'FWD' },
      // Punta solitaria
      { x: 4.7, y: 1, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '4-3-1-2',
    ...
    positions: [
      ...
      { x: 4.7, y: 2, label: 'ATT', role: 'FWD' },
      // Attacco a 2
      { x: 3.7, y: 1, label: 'ATT', role: 'FWD' },
      { x: 5.7, y: 1, label: 'ATT', role: 'FWD' },
    ],
  },
  {
    id: '3-4-3',
