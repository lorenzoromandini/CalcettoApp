...
export function MatchDetailPageClient({
  ...
  const ourGoalsCount = goals.filter(g => g.teamId === teamId && !g.isOwnGoal).length;
      ...
      {(isInProgress || isFinished) && (
        <div className="grid gap-4 md:grid-cols-2 mb-6">
          ...
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <Link href={`/${locale}/teams/${teamId}/matches/${matchId}/results`}>
          ...
          {isFinished && (
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <Link href={`/${locale}/teams/${teamId}/matches/${matchId}/ratings`}>
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
            ...
            {isFormationLoading ? (
              ...
              <div className="space-y-4">
                ...
                <Button asChild variant="outline" className="w-full">
                  <Link href={`/${locale}/teams/${teamId}/matches/${matchId}/formation`}>
